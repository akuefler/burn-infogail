...
include("../../jeremy/validation/Auto2D.jl")
...
for trajdata_path in TRAJDATA_PATHS
    ...
    metricset = Array(Float64, length(metrics), n_states)
    ...
    * ".jld")
    ...
    JLD.save(outfile, "features", featureset, "metrics", metricset, "targets", targetset, "intervals", interval_starts, "timestep", ΔT)
    toc()
end
