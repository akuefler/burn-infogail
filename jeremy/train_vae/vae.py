...
NONLINS = {"relu":tf.nn.relu, "tanh":tf.nn.tanh}
...
class VariationalAutoencoder():
    def __init__(self, args):
        ...
        self.f = NONLINS[args.nonlinearity]
    ...
    def _create_reconstructor(self, args):
        ...
        output = self.f(tf.nn.xw_plus_b(rec_in, W, b))
        ...
        for i in xrange(1, args.num_rec_layers):
            ...
            output = self.f(tf.nn.xw_plus_b(output, W, b))
