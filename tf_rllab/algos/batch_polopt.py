...
class BatchPolopt(RLAlgorithm):
    ...
    def __init__(
        ...
        self.save_models = kwargs["save_models"]
        self.init_opt()
	self.reward_threshold = reward_threshold
	self.itr_threshold = itr_threshold
                    ...
                    if self.plot:
                        ...
                        if self.pause_for_plot:
                            input("Plotting evaluation run: Press Enter to "
                                  "continue...")
#                    if samples_data['AverageEnvReturn'] < self.reward_threshold \
#                       and self.itr_threshold < itr:
#                        break
